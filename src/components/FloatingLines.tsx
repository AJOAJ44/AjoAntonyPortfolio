...
export default function FloatingLines({
  ...
  useEffect(() => {
    ...
    const material = new ShaderMaterial({
      uniforms: uniforms as unknown as Record<string, { value: number | Vector2 | Vector3 | boolean | Vector3[] }>,
      vertexShader,
      fragmentShader,
    });
    ...
    const setSize = () => {
      ...
      uniforms.iResolution.value = new Vector3(canvasWidth, canvasHeight, 1);
    };
