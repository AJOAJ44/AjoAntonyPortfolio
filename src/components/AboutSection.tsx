...
export default function AboutSection() {
  return (
    <section id="about" className="min-h-screen relative flex flex-col items-center justify-center px-5 sm:px-8 md:px-10 py-20 overflow-hidden" style={{ backgroundColor: '#0C0C0C' }}>
      <FadeIn
        as="img"
        delay={0.1}
        x={-80}
      ...
      />
        ...
        <AnimatedText
          ...
          className="text-[#D7E2EA] font-medium text-center leading-relaxed max-w-[561px]"
